...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "9yLNukm58cCDUNJ3tqc776Oo1", consumerSecret: "b0t1PH5XqAWl8GRyeSAvISmNqQgvZ69ZlpVLfqLNPlrrvS8gM7")
    var loginSuccess: (() -> ())?
